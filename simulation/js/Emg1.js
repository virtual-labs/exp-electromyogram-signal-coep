...
{
l=100;
 r=new  Raphael(document.getElementById('First1'),1340,500);
  //var curve=r.path("M360 120 s -10 10 0,10");
	...
	//two dots	
				circle1 = r.circle(100,180, 4).attr({fill:"red"});
	...
	//Total text
				...
				var t1=r.text(400,70," EMG Electrode").attr({"font-size":14});
			        ...
			        TEXT1=r.text(60,170," l").attr({"font-size":14});
					TEXT2=r.text(60,230," t").attr({"font-size":14});
				    TEXT3=r.text(60,300,"l").attr({"font-size":14});
				    TEXT4=r.text(60,380," t").attr({"font-size":14});
				
				    TEXT5=r.text(65,175," 1").attr({"font-size":14});
				    TEXT6=r.text(65,235," 1").attr({"font-size":14});
				    TEXT7=r.text(65,305,"2").attr({"font-size":14});
					TEXT8=r.text(65,385," 2").attr({"font-size":14});
				
					TEXT9=r.text(85,170," mm").attr({"font-size":14});
					TEXT10=r.text(85,230," ms").attr({"font-size":14});
				    TEXT11=r.text(85,300,"mm").attr({"font-size":14});
				    TEXT12=r.text(85,380," ms").attr({"font-size":14});
				
				
				//var t1=r.text(230,300," Distance l"(+265,305,"1")+275,300,"="+310,300,"310mm"+230,380," Latency t"+265,385,"1"+275,380,"="+310,380,"60mm").attr({"font-size":14});
